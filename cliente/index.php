...
<body>
  <div class="container pt-5">
    ...
    <hr>
    <h5 class="text-center">Cadastro de Cliente</h5>
    <hr>
    ...
    try {
      ...
      $output .= "<div class='col-3'><strong>Nome</strong></div><div class='col-3'><strong>Email</strong></div><div class='col-3'><strong>Telefone</strong></div><div class='col-3'><strong>Criado</strong></div>";

      $data = $stmt->fetchAll();
      // and somewhere later:
      foreach ($data as $row) {
        $output .= "<div class='col-3'>$row[nome]</div><div class='col-3'>$row[email]</div><div class='col-3'>$row[telefone]</div><div class='col-3'>$row[data_criado]</div>";
      }
